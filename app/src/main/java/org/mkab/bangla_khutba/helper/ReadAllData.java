...
import org.mkab.bangla_khutba.adapter.MyArrayAdapterCRUD;
...
public class ReadAllData extends AppCompatActivity {
    ...
    private ArrayList <MyDataModelCRUD> list;
    private MyArrayAdapterCRUD adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list = new ArrayList < > ();
        adapter = new MyArrayAdapterCRUD(this, list);
                    ...
                    if (jsonObject.length() > 0) {
                        ...
                        if (lenArray > 0) {
                            for (; jIndex < lenArray; jIndex++) {
                                 ...
                                 * Adding into List
                                 */
                                MyDataModelCRUD model = new MyDataModelCRUD();
