...
import org.mkab.bangla_khutba.adapter.MyArrayAdapter;
import org.mkab.bangla_khutba.model.MyDataModel;
                    ...
                    if(jsonObject.length() > 0) {
                        ...
                        if(lenArray > 0) {
                            for( ; jIndex < lenArray; jIndex++) {
                                ...
                                String nameOfKaid = innerObject.getString(Keys.KEY_NAME_OF_QUAID);
//                                String image = innerObject.getString(Keys.KEY_IMAGE);
                                ...
                                model.setNameOfKaid(nameOfKaid);
